...
const Signup = () => {
  ...
  useEffect(() => {
    if (authState.isAuthenticated && window.location.pathname === "/signup") {
      console.log(
        "Authenticated user detected, redirecting based on role:",
        authState.userRole
      );
      const redirectPath =
        authState.userRole === "viewer" ? "/welcome" : "/dashboard";
  ...
  const handleSubmit = async (e) => {
    ...
    if (!validatePassword(password)) {
      setPasswordError(
        'Your password must be at least 8 characters long and include Symbols (!@#$%^&)"**'
      );
      setLoading(false);
      return;
    }
    ...
    >
      <Paper
        ...
        sx={{
          ...
          borderRadius: 3,
          background:
            muiTheme.palette.background?.paper || "rgba(255, 255, 255, 0.9)",
          backdropFilter: "blur(10px)",
          border: muiTheme.palette.border?.main || "rgba(0, 0, 0, 0.1)",
          boxShadow:
            muiTheme.custom?.shadow?.paper ||
            (theme.isDarkMode
          ...
          <TextField
            ...
            sx={{
              "& .MuiOutlinedInput-root": {
                ...
                "& fieldset": {
                  borderColor:
                    muiTheme.palette.border?.main || "rgba(0, 0, 0, 0.1)",
                },
                "&:hover fieldset": {
                ...
                "&:hover": {
                  ...
                  boxShadow:
                    muiTheme.custom?.shadow?.listItem ||
                    (theme.isDarkMode
          ...
          <TextField
            ...
            sx={{
              "& .MuiOutlinedInput-root": {
                ...
                background:
                  muiTheme.palette.background?.listItem ||
                  "rgba(255, 255, 255, 0.5)", // Vibrant green for consistency with branding
                transition: "all 0.3s ease",
                "& fieldset": {
                  borderColor:
                    muiTheme.palette.border?.main || "rgba(0, 0, 0, 0.1)",
