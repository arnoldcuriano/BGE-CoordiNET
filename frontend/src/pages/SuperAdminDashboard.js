...
const SuperAdminDashboard = () => {
  console.log("SuperAdminDashboard: Rendering component");
  ...
  useEffect(() => {
    ...
    if (!authState.isAuthenticated || authState.userRole !== "superadmin") {
      console.log(
        "SuperAdminDashboard: Redirecting to /dashboard due to role check failure"
      );
      navigate("/dashboard");
      return;
    }
        ...
        >
          <Fade in={approveConfirmModal.open}>
            ...
            >
              ...
              >
                Are you sure you want to approve {approveConfirmModal.userName}{" "}
                as a {approveConfirmModal.role}?
              </Typography>
              <Box sx={{ display: "flex", gap: 2, justifyContent: "flex-end" }}>
                <Button
